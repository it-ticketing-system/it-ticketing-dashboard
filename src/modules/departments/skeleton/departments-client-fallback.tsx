...
const DepartmentsClientFallback = () => {
  return (
    <div className="flex flex-col gap-6">
      {/* Filters Skeleton */}
      <div className="bg-surface border-border flex w-full flex-col gap-4 rounded-xl border p-4 shadow-sm md:flex-row md:items-center justify-between">
...
export default DepartmentsClientFallback;
