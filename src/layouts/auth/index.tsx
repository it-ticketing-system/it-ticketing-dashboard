...
const AuthLayout: FCC = async ({ children }) => {
  ...
  return (
    <main className="bg-background flex min-h-dvh w-full items-center justify-center px-4 py-6 sm:px-5 md:px-6 lg:px-8">
      <div className="bg-surface border-border flex w-full max-w-7xl flex-col-reverse overflow-hidden rounded-xl border shadow-sm lg:min-h-160 lg:flex-row">
