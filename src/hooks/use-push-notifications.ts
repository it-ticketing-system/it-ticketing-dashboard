...
import usePushNotificationContext from './use-push-notification-context';
...
const usePushNotifications = () => {
  const { isOnline, pushSupport } = usePushNotificationContext();
  ...
  return {
    ...
    isConfigLoading: configQuery.isLoading || configQuery.isFetching,
    isConfigReady: configQuery.isFetched,
