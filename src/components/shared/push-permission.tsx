...
interface PushPermissionProps {
  hideIfBackendDisabled?: boolean;
  hideIfSubscribed?: boolean;
  showDismissButton?: boolean;
}

const PushPermission = ({
  hideIfBackendDisabled = false,
  ...
  if (hideIfBackendDisabled && !isBackendEnabled && isOnline) {
    return null;
  }
  ...
  return (
    <div className="border-border bg-surface flex flex-col gap-3 rounded-xl border p-4 text-start shadow-sm lg:flex-row lg:items-center lg:justify-between">
      <div className="flex items-start gap-3">
        <div className="bg-accent-soft text-accent-soft-foreground flex size-10 shrink-0 items-center justify-center rounded-md">
